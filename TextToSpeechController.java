//Handles the back end functionalities of our GUI
...
public class TextToSpeechController {
    ...
    public static ArrayList<String> getVoices(){
        //after doing this go back to GUI and add to combo box
    ...
    //Gonna implement the text-to-speech feature
    public static void speak (String message, String voiceType, String rate, String volume){
        ...
        //set the speed at which the text will be spoken (words per min)
